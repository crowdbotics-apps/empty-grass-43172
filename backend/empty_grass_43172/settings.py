"""
Django settings for empty_grass_43172 project.
...
ROOT_URLCONF = 'empty_grass_43172.urls'
...
WSGI_APPLICATION = 'empty_grass_43172.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_grass_43172 API",
    "DESCRIPTION": "API documentation for empty_grass_43172 App",
    "VERSION": "v1",
}
